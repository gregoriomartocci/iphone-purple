...
const VARIANTS = {
  ...
  outline:
    "border border-line text-ink hover:border-ink px-6 h-12 rounded-full inline-flex items-center justify-center gap-2 text-sm font-medium transition-colors",
  bare: "inline-flex items-center gap-2 text-sm text-ink hover:text-purple transition-colors",
} as const;
