  ...
  return (
    <div className="shell py-12 sm:py-16">
      <header className="max-w-2xl">
        <h1 className="text-3xl font-semibold sm:text-5xl">Reparaciones</h1>
        <p className="text-muted-foreground mt-4 text-lg leading-relaxed">
          Servicio técnico propio, acá mismo. Diagnóstico sin cargo, presupuesto antes de
          tocar nada y tres meses de garantía sobre la reparación.
        </p>
        <WhatsAppLink
          ...
          {services.map((service) => (
            ...
            >
              <div className="min-w-0 flex-1">
                <h3 className="text-ink font-medium">{service.name}</h3>
      ...
      <section className="bg-surface mt-20 rounded-2xl p-8 sm:p-10">
        ...
        <ul className="mt-6 grid gap-6 sm:grid-cols-2">
          <li>
            <h3 className="text-ink text-sm font-medium">Hacé un backup</h3>
            <p className="text-muted-foreground mt-1.5 text-sm leading-relaxed">
              Toda reparación tiene riesgo de pérdida de datos. Un respaldo en iCloud o en
              la computadora te deja tranquilo.
            </p>
          </li>
          <li>
            <h3 className="text-ink text-sm font-medium">Desactivá «Buscar mi iPhone»</h3>
            <p className="text-muted-foreground mt-1.5 text-sm leading-relaxed">
          ...
          <li>
            <h3 className="text-ink text-sm font-medium">Contanos qué le pasó</h3>
            <p className="text-muted-foreground mt-1.5 text-sm leading-relaxed">
              Si se cayó, se mojó o ya lo abrieron antes, decilo. Cambia el diagnóstico y
              nos ahorra tiempo a los dos.
            </p>
          </li>
          <li>
            <h3 className="text-ink text-sm font-medium">Traé el cargador si podés</h3>
            <p className="text-muted-foreground mt-1.5 text-sm leading-relaxed">
